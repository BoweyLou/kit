...
Start with `make context-packet` or an installed context bundle when available.
...
- Supporting context:
  - `<context-packet item, context-bundle item, doc, ADR, caller, test, script, or receipt>`
- Uncertainty:
