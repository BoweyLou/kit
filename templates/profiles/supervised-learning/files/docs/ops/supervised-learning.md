...
state, and Kit does not execute its recommendation. Task-packet and receipt
linkage remain deferred to a later phase.
...
`schemas/` define the portable record shapes. Context remains deferred.
